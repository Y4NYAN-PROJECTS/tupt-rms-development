        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-12">
                <div class="page-header-title">
                    <h2 class="mb-0">My Folders and Files</h2>
                </div>
            </div>
        </div>
    </div>
...
<?php if ($foldercode != 0): ?>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-default-icon">
            <li class="breadcrumb-item"><a href="/EmployeeController/FilesPage/0">Home</a></li>
            <?php foreach ($hierarchypath as $hierarchy): ?>
                <li class="breadcrumb-item"><a href="/EmployeeController/FilesPage/<?= $hierarchy['folder_code'] ?>"><?= $hierarchy['folder_name'] ?></a></li>
            <?php endforeach; ?>
        </ol>
    </nav>
<?php else: ?>
                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1 mx-3">
                                <a href="/EmployeeController/FilesPage/<?= $folder['folder_code'] ?>">
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="dropdown">
                                            <a class="avtar avtar-xs btn-link-secondary dropdown-toggle arrow-none" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="material-icons-two-tone f-18">more_vert</i></a>
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a class="dropdown-item rename-file-button" href="#" data-file-id="<?= $file['file_id'] ?>" data-file-name="<?= $file['file_name'] ?>" data-bs-toggle="modal" data-bs-target="#renameFile">Rename</a>
...
<div class="modal fade" id="uploadFile" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="/EmployeeController/SaveFile" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    <input type="file" class="image-crop-filepond" multiple data-allow-reorder="true" data-max-file-size="5MB" data-max-files="5" accept="application/pdf,
...
<div class="modal fade" id="createFolder" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="/EmployeeController/SaveFolder" method="post" id="createFolderForm">
                <div class="modal-body">
                    <div class="row">
...
<div class="modal fade" id="editFolder" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="/EmployeeController/SaveFolder" method="post">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12 mb-3">
...
<!-- [ Rename File ] -->
<div class="modal fade" id="renameFile" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <div class="">
                    <h3 class="modal-title">Rename File</h3>
                    <small>Input the new file name to change.</small>
                </div>
                <button class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <form action="/EmployeeController/RenameFile" method="post" id="renameFileForm">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12 mb-3">
                            <label class="form-label" for="renamefile-name">File Name</label>
                            <input type="text" class="form-control" id="renamefile-filename" placeholder="File Name" name="emp_filename" required />
                        </div>

                        <!-- [ Hidden Input ] -->
                        <input type="hidden" name="emp_fileid" id="renamefile-fileid">
                        <input type="hidden" name="emp_parentfoldercode" value="<?= $foldercode ?>">
                        <!-- [ Hidden Input ] -->
                    </div>
                </div>
...
<script>
    ...
    // [ Share Folder ]
    document.addEventListener('DOMContentLoaded', function () {
        const shareButtons = document.querySelectorAll('[data-bs-target="#shareFolder"]');
    ...
    // [ Rename File ]
    document.addEventListener('DOMContentLoaded', function () {
        const renameButtons = document.querySelectorAll('[data-bs-target="#renameFile"]');
        ...
        renameButtons.forEach(button => {
            button.addEventListener('click', function () {
                ...
                const modalFileId = document.getElementById('renamefile-fileid');
                const modalFileName = document.getElementById('renamefile-filename');

                if (modalFileId) modalFileId.value = fileid;
                if (modalFileName) modalFileName.value = filename;
            });
        });
    });
