                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-6 col-md-6 col-lg-6 mb-3">
                                        ...
                                        <p class="mb-0"><?= $user['employee_type_name'] ?? '-' ?>
                                        </p>
                                    </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="/AdminController/RedirectToProfileUpdate">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card" id="update-profile">
                            ...
                            <form action="/AdminController/UpdateProfile" method="post">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-6">
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-7">
                        <div class="card" id="change-password">
                            ...
                            <form action="/AdminController/ChangePassword" method="post">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
...
<script>
    ...
    //         $.ajax({
    //             url: '/AdminController/ChangeEmailOTP',
    //             type: 'POST',
    //             data: {
