                            ...
                            <tbody>
                                <?php foreach ($employees as $employee): ?>
                                    <tr>
                                        ...
                                        <td><?= $employee['plantilla_title'] ?></td>
                                        <td><?= $employee['role_code'] ?? 'Not Assigned' ?></td>
                                        <td class="text-center">
                                            <a href="/AdminController/ProfileVisit/<?= $employee['account_code'] ?>" class="avtar avtar-xs btn-link-secondary">
                                                <i class="ti ti-eye-off f-20" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Visit Profile"></i>
                                            </a>

                                            <a href="#" class="avtar avtar-xs btn-link-secondary" data-bs-toggle="modal" data-bs-target="#updateRole" data-account-id="<?= $employee['account_id'] ?>" data-role-id="<?= $employee['role_id'] ?? 0 ?>">
    ...
    <div class="card">
        <div class="card-body d-flex justify-content-center align-items-center">
            <div class="text-center fst-italic my-5">
                <h1>No Employee/s Found!</h1>
                <p class="m-0">There are no employee accounts.</p>
            </div>
        </div>
    </div>
<?php endif; ?>
