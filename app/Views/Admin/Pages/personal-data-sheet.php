...
<div class="row">
    <div class="col-xxl-12 col-md-12">
        <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link position-relative" id="pds-print-tab" target="_blank" href="/AdminController/PDSPrintPage">
                    <span class="pc-micon">
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade <?= (session()->get('fd_column') == 'personal') ? 'show active' : ''; ?>" id="personal" role="tabpanel" aria-labelledby="personal-tab">
                <form action="/AdminController/SavePDS" method="post">
                    <div class="card">
...
<script>
    $(document).ready(function () {
        ...
        $.get("<?= site_url('AdminController/fetchDataCity') ?>", function (data) {
        ...
        $("#ra-city").change(function () {
            ...
            if (cityCode) {
                $.get("<?= site_url('AdminController/fetchDataBarangay') ?>/" + cityCode, function (data) {
